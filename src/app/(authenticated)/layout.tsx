...
export default function AuthenticatedLayout({
  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
      {/* Mobile menu button - Only for theme toggle */}
      <button
      ...
      <div className="hidden md:block fixed inset-y-0 left-0 w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 z-40">
        ...
        <div className="flex items-center justify-around px-2 py-2">
          <Link
            ...
            className={`flex flex-col items-center p-2 rounded-lg ${
              pathname === '/chat' ? 'text-primary-600 dark:text-primary-400' : 'text-gray-600 dark:text-gray-400'
            }`}
          >
            <svg
              className="w-6 h-6"
          ...
          <Link
            href="/groups"
            className={`flex flex-col items-center p-2 rounded-lg ${
              pathname === '/groups' ? 'text-primary-600 dark:text-primary-400' : 'text-gray-600 dark:text-gray-400'
            }`}
          >
            <svg
              className="w-6 h-6"
          ...
          <Link
            href="/notifications"
            className={`flex flex-col items-center p-2 rounded-lg ${
              pathname === '/notifications' ? 'text-primary-600 dark:text-primary-400' : 'text-gray-600 dark:text-gray-400'
            }`}
          >
            <svg
              className="w-6 h-6"
          ...
          <Link
            href="/profile"
            className={`flex flex-col items-center p-2 rounded-lg ${
              pathname === '/profile' ? 'text-primary-600 dark:text-primary-400' : 'text-gray-600 dark:text-gray-400'
            }`}
          >
            {profile?.avatar_url ? (
              <img
      ...
      <main className="flex-1 md:ml-64 min-h-screen w-full">
        <div className="pt-16 md:pt-0 px-4 pb-20 md:pb-0 h-full">
          {children}
        </div>
      </main>
    </div>
