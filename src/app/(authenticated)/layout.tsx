...
export default function AuthenticatedLayout({
  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 z-40 transition-transform duration-300 ease-in-out`}>
      ...
      <main className="flex-1 md:ml-64 min-h-screen w-full">
        <div className="pt-16 md:pt-0 px-4 h-full">
          {children}
        </div>
      </main>
    </div>
